...
For CFA models, a general M-estimator defined by the estimating equations  
$$
U(\theta)
...
Under correct specification, the sensitivity matrix takes the form
$$
H(\theta)=\bDelta_{\theta}^{T}W_{\theta}\,\bDelta_{\theta}.
$$
